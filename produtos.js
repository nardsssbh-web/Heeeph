...
const PRODUTOS = {
  bandas: [
    ...
    { id: "bandas-angra", nome: "Angra-Angels Cry", imagem: "placas/bandas/angra.png", preco: "preço aqui" },
    ...
    { id: "bandas-bs-caravan", nome: "Black Sabbath-Planet Caravan", imagem: "placas/bandas/bs-caravan.png", preco: "preço aqui" },
    { id: "bandas-bs-hell", nome: "Black Sabbath-Heaven in Hell", imagem: "placas/bandas/bs-hell.png", preco: "preço aqui" },
    { id: "bandas-bs-master", nome: "Black Sabbath-Master of Reallity", imagem: "placas/bandas/bs-master.png", preco: "preço aqui" },
    { id: "bandas-cannibal", nome: "Cannibal Corpse Banda", imagem: "placas/bandas/cannibal.png", preco: "preço aqui" },
    { id: "bandas-cannibal1", nome: "Cannibal Corpse ", imagem: "placas/bandas/cannibal1.png", preco: "preço aqui" },
    ...
    { id: "bandas-dio-holy", nome: "Dio - Holy Diver", imagem: "placas/bandas/dio-holy.png", preco: "preço aqui" },
    { id: "bandas-dire-straits-brother", nome: "Dire Straits-Brothers in Arms", imagem: "placas/bandas/dire-straits-brother.png", preco: "preço aqui" },
    ...
    { id: "bandas-megatheath-rust", nome: "Megadeth - Rust in Peace", imagem: "placas/bandas/megatheath-rust.png", preco: "preço aqui" },
    { id: "bandas-metallica-justice", nome: "Metallica Justice for All", imagem: "placas/bandas/metallica-justice.png", preco: "preço aqui" },
    ...
    { id: "bandas-pantera-far", nome: "Pantera-Far Beyond", imagem: "placas/bandas/pantera-far.png", preco: "preço aqui" },
    { id: "bandas-pantera-hell", nome: "Pantera-Cowboys from Hell", imagem: "placas/bandas/pantera-hell.png", preco: "preço aqui" },
    { id: "bandas-pantera-vulgar", nome: "Pantera-Vulgar and Display", imagem: "placas/bandas/pantera-vulgar.png", preco: "preço aqui" },
    ...
    { id: "bandas-ratm-los", nome: "Rage Against-The Battle of Los Angeles", imagem: "placas/bandas/ratm-los.png", preco: "preço aqui" },
    ...
    { id: "bandas-sepultura-inner", nome: "Sepultura-Arise", imagem: "placas/bandas/sepultura-inner.png", preco: "preço aqui" },
  ...
  bebidas: [
    { id: "bebida-reuniao", nome: "Bebida não pode faltar !!", imagem: "placas/bebida/bebida-reuniao.png", preco: "preço aqui" },
    { id: "bebidas-good-beer", nome: "Good Good Good", imagem: "placas/bebida/good-beer.png", preco: "preço aqui" },
  ...
  games: [
    ...
    { id: "games-mortal", nome: "Mortal Kombat", imagem: "placas/games/mortal.png", preco: "preço aqui" },
    { id: "games-pac", nome: "Pac-Man", imagem: "placas/games/pac.png", preco: "preço aqui" },
    { id: "games-retro", nome: "Retrô Gamer", imagem: "placas/games/retro.png", preco: "preço aqui" },
  ...
  infantil: [
    { id: "infantil-bat", nome: "Batman", imagem: "placas/infantil/bat.png", preco: "preço aqui" },
    { id: "infantil-superm", nome: "Meu Super Herói !!", imagem: "placas/infantil/superm.png", preco: "preço aqui" },
    { id: "infantil-brincar", nome: "Ideal para o quarto !!", imagem: "placas/infantil/brincar.png", preco: "preço aqui" },
    { id: "infantil-cachorro", nome: "Cachorrinho", imagem: "placas/infantil/cachorro.png", preco: "preço aqui" },
    { id: "infantil-doces-sonhos", nome: "Doces Sonhos", imagem: "placas/infantil/doces-sonhos.png", preco: "preço aqui" },
    { id: "infantil-dormir", nome: "Hora do Soninho...", imagem: "placas/infantil/dormir.png", preco: "preço aqui" },
    { id: "infantil-tigre", nome: "Coleção - Tigre", imagem: "placas/infantil/tigre.png", preco: "preço aqui" },
    { id: "infantil-zebra", nome: "Coleção - Zebra", imagem: "placas/infantil/zebra.png", preco: "preço aqui" },
    { id: "infantil-elefante", nome: "Coleção - Elefante", imagem: "placas/infantil/elefante.png", preco: "preço aqui" },
    { id: "infantil-giraffa", nome: "Coleção - Girafa", imagem: "placas/infantil/giraffa.png", preco: "preço aqui" },
    { id: "infantil-hippo", nome: "Coleção - Hippo", imagem: "placas/infantil/hippo.png", preco: "preço aqui" },
    { id: "infantil-leao", nome: "Coleção - Leão", imagem: "placas/infantil/leao.png", preco: "preço aqui" },
    { id: "infantil-macaco", nome: "Coleção - Macaco", imagem: "placas/infantil/macaco.png", preco: "preço aqui" },
    ...
    { id: "infantil-quartinho-abencoado-m", nome: "Para o quartinho dela", imagem: "placas/infantil/quartinho-abençoado-m.png", preco: "preço aqui" },
  ...
  motos: [
    ...
    { id: "motos-velho", nome: "Velho Demais", imagem: "placas/motos/velho.png", preco: "preço aqui" }
  ],

  musica: [
    { id: "musica-musica1", nome: "Escala Pentatônica", imagem: "placas/musica/escala-pentatonica.png", preco: "R$29,90" },
    { id: "musica-musica2", nome: "Modos Gregos", imagem: "placas/musica/modos.png", preco: "R$29,90" },
    { id: "musica-musica3", nome: "Sem Música Não Dá !!!!", imagem: "placas/musica/sem-musica.png", preco: "R$29,90" },
  ...
  rpg: [
    ...
    { id: "rpg-adaga", nome: "Senhora Adaga", imagem: "placas/rpg/adaga.png", preco: "preço aqui" },
    { id: "rpg-arco", nome: "Arco Elétrico ", imagem: "placas/rpg/arco.png", preco: "preço aqui" },
    { id: "rpg-espada-gelo", nome: "Espada de Gelo", imagem: "placas/rpg/espada-gelo.png", preco: "preço aqui" },
    { id: "rpg-gelo", nome: "Morgana do Gelo", imagem: "placas/rpg/gelo.png", preco: "preço aqui" },
    { id: "rpg-machado", nome: "Machado Lança de corte", imagem: "placas/rpg/machado.png", preco: "preço aqui" },
    { id: "rpg-mapa", nome: "Em Busca Do Tesouro !!", imagem: "placas/rpg/mapa.png", preco: "preço aqui" },
    { id: "rpg-nature", nome: "Cajado Nature Life", imagem: "placas/rpg/nature.png", preco: "preço aqui" },
    { id: "rpg-pureza", nome: "Cajado da Pureza", imagem: "placas/rpg/pureza.png", preco: "preço aqui" }
  ],

  street: [
    { id: "street-chao", nome: "Chão", imagem: "placas/street/chao.png", preco: "preço aqui" },
    { id: "street-hh-h", nome: "Hip Hop Ele", imagem: "placas/street/hh-h.png", preco: "preço aqui" },
    { id: "street-hh-m", nome: "Hip Hop  Ela", imagem: "placas/street/hh-m.png", preco: "preço aqui" },
    { id: "street-jacketa", nome: "Jacketa", imagem: "placas/street/jacketa.png", preco: "preço aqui" },
    { id: "street-naipess", nome: "Naipes Baralho", imagem: "placas/street/naipess.png", preco: "R$29,90" },
    { id: "street-naopedelicença", nome: "Jamais !!!!", imagem: "placas/street/naopedelicença.png", preco: "preço aqui" },
    ...
    { id: "street-skate1", nome: "Coleção", imagem: "placas/street/skate1.png", preco: "preço aqui" },
    { id: "street-skate2", nome: "Coleção", imagem: "placas/street/skate2.png", preco: "preço aqui" },
    { id: "street-skate3", nome: "Coleção", imagem: "placas/street/skate3.png", preco: "preço aqui" },
    { id: "street-skateh", nome: "Skate Boy", imagem: "placas/street/skateh.png", preco: "preço aqui" },
    { id: "street-skatem", nome: "Skate Girl", imagem: "placas/street/skatem.png", preco: "preço aqui" },
    { id: "street-skatista", nome: "Skatista de Respeito", imagem: "placas/street/skatista.png", preco: "preço aqui" },
    ...
    { id: "street-tenis-fio", nome: "Assim é na quebrada !", imagem: "placas/street/tenis-fio.png", preco: "preço aqui" }
  ],

  trip: [
    { id: "trip-kombi", nome: "Kombosa da Paz", imagem: "placas/trip/modo-kombi.png", preco: "preço aqui" },
    { id: "trip-reggae", nome: "Regue a Vida com muito Amor !", imagem: "placas/trip/reggae-a-vida.png", preco: "preço aqui" },
    { id: "trip-leoao-erva", nome: "Leão de Folhas", imagem: "placas/trip/leao-erva.png", preco: "preço aqui" },
